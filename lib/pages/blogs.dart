    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          SizedBox(height: 20),
          Padding(
            padding: const EdgeInsets.only(left: 8.0), // Add padding to the left of the title
            child: Text(
              'Blogs',
              style: TextStyle(
                fontSize: 20,
          ...
          SizedBox(height: 10), // Add space between content and list
          Expanded(
            child: ListView.separated(
              separatorBuilder: (context, index) =>
                  SizedBox(height: 10), // Add space between list tiles
              itemCount: 3,
          ...
          Padding(
            padding: const EdgeInsets.only(
                left: 8.0), // Add padding to the left of the title
            child: Text(
              'Podcasts',
              style: TextStyle(
                fontSize: 20,
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    trailing: InkWell(
                      onTap: () async {
                        final url = spotifyUrls[index]; // Get the Spotify URL based on the index
                      ...
                      child: Icon(Icons.arrow_forward), // Example icon
                    ),
                  ),
                );
              },
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    trailing: InkWell(
                      onTap: () async {
                        final url = youtubeUrls[index]; // Get the Spotify URL based on the index
                        if (await canLaunch(url)) {
                          await launch(url);
                        } else {
                          throw 'Could not launch $url';
